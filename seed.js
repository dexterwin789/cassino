...
async function seed() {
  ...
  const games = [
    ...
    ['mines-pro', 'Mines Pro', '', 'wg', 'mines', 13],
    ['crash-x', 'Crash X', '', 'wg', 'crash', 14],
    ['dice-master', 'Dice Master', '', 'wg', 'dice', 15],
    ['super-ace', 'Super Ace', '', 'jili', 'jili', 16],
    ['boxing-king', 'Boxing King', '', 'jili', 'jili', 17],
    ['money-coming', 'Money Coming', '', 'jili', 'jili', 18],
    ['golden-empire', 'Golden Empire', '', 'jili', 'quente', 19],
    ['treasure-hunt', 'Treasure Hunt', '', 'cq9', 'cq9', 20],
    ['jump-high', 'Jump High', '', 'cq9', 'cq9', 21],
    ['hot-fruits', 'Hot Fruits', '', 'evor', 'evor', 22],
    ['spaceman', 'Spaceman', '', 'pp', 'crash', 23],
    ['sweet-bonanza', 'Sweet Bonanza', '', 'pp', 'pp', 24]
  ];
  ...
  const promos = [
    ...
    { title: 'Happy Hour - Sexta-feira', desc: 'Todas as sextas: depósitos com 50% extra das 18h às 23h.', type: 'bonus', cents: 0, pct: 50, minDep: 3000, maxUses: 0, code: 'FRIDAY50', active: false, expires: 7 },
