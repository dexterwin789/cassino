...
function gameCardHTML(game) {
  ...
  h += '<img src="' + img + '" alt="' + name + '" draggable="false" loading="lazy" onerror="this.onerror=null;this.src=\'/public/img/novo/login-banner.png\'">';
...
function searchCardHTML(game) {
  ...
  return '<a href="/game/' + code + '" class="game-card" title="' + name + '" style="text-decoration:none">' +
    '<img src="' + img + '" alt="' + name + '" draggable="false" loading="lazy" onerror="this.onerror=null;this.src=\'/public/img/novo/login-banner.png\'">' +
